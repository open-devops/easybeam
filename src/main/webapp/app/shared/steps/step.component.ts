...
@Directive({
  selector: '[td-step-header-actions]ng-template',
})
export class TdStepHeaderActionsDirective extends TemplatePortalDirective {
...
export class TdStepComponent implements OnInit {
  ...
  @ContentChild(TdStepHeaderActionsDirective) stepHeaderActions: TdStepHeaderActionsDirective;
